...
namespace TEST1
{
	...
	public:
		...
		{
			//Testing the perimeter function
			int result = 0;
			int l = 1;
			int b = 1;
		...
		TEST_METHOD(LenghtFunctionality1)
		{
			//Testing the funtion to change the lenght value to 55 and check if it accept it
			int userinput = 55;
			int result = 0;
		...
		{
			//Testing the funtion to change the breadth value to 58 and check if it accept it
			int userinput = 58;
			int result = 0;
		...
		{
			//Testing the funtion to change the width value to 1 and check if it accept it
			int userinput = 1;
			int result = 0;
			setWidth(userinput, &result);
			Assert::AreEqual(1, result);
		...
		{
			//Testing the funtion to change the width value to 39 and check if it accept it
			int userinput = 39;
			int result = 0;
			setWidth(userinput, &result);
